...
class ShipmentServer {
    ...
    constructor(shipment, options) {
        ...
        this.encryptSettings = options.encryptSettings;
     ...
     */
    enableEncryption() {
        const modulusBits = this.encryptSettings.modulusBits || 2048;
        const exponent    = this.encryptSettings.exponent || 65537;
        const key = ursa.generatePrivateKey(modulusBits, exponent);
        this.private      = key;
