...
const {kebabCase, extend, reduce, isObject} = require('lodash');
...
class Action {
    ...
    async execute(context, args) {
        let result;
        const options = this.parseArgs(args, context);
     ...
     * @param {Object} [args = {}]
     * @param {Context|null} [context = null] Context in which the action is being executed
     * @returns {Object}
     */
    parseArgs(args = {}, context = null) { // eslint-disable-line no-unused-vars
        return args;
    }
