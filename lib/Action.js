...
class Action {
     ...
     * @returns {Context}
     */
    makeContext(args, cli, parent = null) {
        const options = _.extend({}, this.parseContextArgs(args, cli), {cli: !!cli});
        return new (this.constructor.Context)(options, {}, parent);
    }
    ...
    outputResult(context, result) {
        context.reporter.result(result);
    }
    ...
    executeCli(args, exitCodeOnError, parent = null) {
        return Promise.resolve(this.prepare(this.makeContext(args, true, parent), args)())
            .catch(e => {
    ...
    executeApi(args = {}, parent = null) {
        return this.prepare(this.makeContext(args, false, parent), args)();
    }
