...
module.exports.extend = (BaseContext, factories, reducers) => {
    ...
    SubContext.eventFactories = _.extend.apply(_, [{}, BaseContext.eventFactories].concat(arrify(factories)));
    SubContext.eventReducers  = _.concat(BaseContext.eventReducers, reducers ? reducers : []);
