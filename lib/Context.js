...
const {assign, clone, defaults, concat} = require('lodash');
...
const makeParser  = require('./events/makeParser');
...
class Context {
    ...
    constructor(options = {}, scope = {}, parentId = null) {
        ...
        const r = makeParser(this.constructor.eventReducers, this.options);
...
/**
 * The default shipment event dictionary
 * @type {Object}
 */
