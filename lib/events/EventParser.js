...
class EventParser extends events.EventEmitter {
    ...
    /**
     * Backwards-compatibility .parser accessor
     * @returns {EventParser}
     */
    get parser() {
        return this;
    ...
    /**
     * Returns a bound "receive" function for convenience
     * @returns {Function}
     */
    get receiver() {
    ...
    /**
     * Add the given function to the end of the handler stack, and make sure handlers that are subsequently
     * added will be inserted before the given one (unless added via `useFinal`)
     *
     * @param {Function} fn
     */
    useFinal(fn) {
